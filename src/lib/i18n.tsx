...
export const translations = {
  fr: {
    ...
    nav_start: "Commencer",
    // Hero
    hero_badge: "Intelligence artificielle malgache",
    ...
    // Footer
    footer_tagline: "Fait par des Malgaches, pour les Malgaches.",
    footer_rights: "Tous droits réservés.",
    // Login
    login_title: "Bienvenue sur fy",
    login_subtitle: "Entrez votre prénom pour commencer",
  ...
  mg: {
    ...
    nav_start: "Manomboka",
    // Hero
    hero_badge: "Faharanitan-tsaina malagasy",
    hero_title_1: "Ny mpanampy IA anao,",
    hero_title_2: "natao ho anao.",
    hero_subtitle:
      "Fantatry ny fy ny toe-javatra anao, miteny ny fitenenana anao ary manampy anao hanao bebe kokoa — fikarohana web, horonantsary, lahatsoratra, feo ary sary.",
    hero_cta: "Manomboka maimaimpoana",
    hero_cta_sub: "Tsy mila karapanantany",
    // Features
    ...
    feat_web_desc: "Mandeha sy maka fomba fanao amin'ny web amin'ny fotoana mety.",
    feat_youtube_title: "Fanadihadiana Video",
    feat_youtube_desc: "Jereo sy manjavona horonantsary YouTube niaraka.",
    feat_text_title: "Famoronana lahatsoratra",
    feat_text_desc: "Soraty, adikao ary amboary ny lahatsoratra aminao amin'ny IA.",
    feat_voice_title: "Famoronana feo",
    feat_voice_desc: "Omeo feo ny vokatrao amin'ny fiteny maro.",
    ...
    feat_multilang_desc: "Interface amin'ny frantsay, malagasy na anglisy.",
    // CTA section
    cta_title: "Vonona hanomboka?",
    cta_subtitle: "Hiditra amin'ny fiarahamonina fy ary jereo ny IA tsy misy fetra.",
    cta_button: "Mamorona kaonty",
    // Footer
    footer_tagline: "Natao ny Malagasy ho an'ny Malagasy.",
    footer_rights: "Zo rehetra voatokana.",
    // Login
    login_title: "Tonga soa eto fy",
    login_subtitle: "Ampidiro ny anaranao mba hanomboka",
    ...
    login_signup: "Misoratra anarana",
    login_or: "na avereno amin'ny",
    // Chat
    chat_placeholder: "Soraty ny hafatrao…",
    chat_new: "Resaka vaovao",
    chat_history: "Tantara",
    ...
    chat_welcome_sub: "Ahoana no ahazoko manampy anao anio?",
    chat_send: "Alefa",
    chat_today: "Anio",
  ...
  en: {
    ...
    login_subtitle: "Enter your first name to get started",
